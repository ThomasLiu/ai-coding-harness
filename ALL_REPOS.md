...
> 所有收录的 AI Coding Harness 仓库 | 共 320 个 | 已 AI 分析: 12 个
...
- **简介**: AI coding assistant skill (Claude Code, Codex, OpenCode, OpenClaw, Factory Droid, Trae). Turn any folder of code, docs, papers, or images into a queryable knowledge graph
