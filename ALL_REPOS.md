...
> 所有收录的 AI Coding Harness 仓库 | 共 327 个 | 已 AI 分析: 9 个
...
- **优点**: - 低代码可视化界面降低AI开发门槛 - 深度集成LangChain生态 - 丰富的预置组件库（提示词/向量库/工具/模型） - 支持多代理编排复杂AI流水线 - 灵活部署（自托管或云服务） 
- **缺点**: - 资源消耗较大，大规模工作流需要较高内存 - 学习曲线陡峭，需熟悉流程图范式和组件体系 
...
- **优点**: - 涵盖多主流大模型（OpenAI/Anthropic/Gemini/开源） - AI Agents 与 RAG 两大核心应用方向 - 社区认可度高（10 万 + Star） - 应用场景丰富覆盖多个领域 
- **缺点**: - 合集性质导致各项目代码质量参差不齐 - 缺乏系统性教程，新手上手门槛较高 
...
- **简介**: Use Garry Tan's exact Claude Code setup: 15 opinionated tools that serve as CEO, Designer, Eng Manager, Release Manager, Doc Engineer, and QA
...
- **简介**: ToolJet is the open-source foundation of ToolJet AI - the AI-native platform for building internal tools, dashboard, business applications, workflows and AI agents 🚀
...
- **简介**: AI agents that run your operations. Model agnostic.
...
- **简介**: Installable GitHub library of 1,304+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and more. Includes installer CLI, bundles, workflows, and official/community skill collections.
...
- **简介**: Warp is the agentic development environment, built for coding with multiple AI agents.
...
- **简介**: Generative Agents: Interactive Simulacra of Human Behavior
...
- **简介**: An AI agent development platform with all-in-one visual tools, simplifying agent creation, debugging, and deployment like never before. Coze your way to AI Agent creation.
...
- **简介**:  This repository delivers end-to-end, code-first tutorials covering every layer of production-grade GenAI agents, guiding you from spark to scale with proven patterns and reusable blueprints for real-world launches.
...
- **简介**: Harness the power of AutoLayout NSLayoutConstraints with a simplified, chainable and expressive syntax. Supports iOS and OSX Auto Layout
...
- **简介**: Outcome driven agent development framework that evolves
...
- **简介**: +192 Claude Code skills & agent plugins for Claude Code, Codex, Gemini CLI, Cursor, and 8 more coding agents — engineering, marketing, product, compliance, C-level advisory.
...
- **简介**: All parts of Claude Code's system prompt, 18 builtin tool descriptions, sub agent prompts (Plan/Explore/Task), utility prompts (CLAUDE.md, compact,  statusline, magic docs, WebFetch, Bash cmd, security review, agent creation).  Updated for each Claude Code version.
...
- **简介**: Simulates Gemini CLI, Antigravity, Qwen Code, and Kiro client requests, compatible with the OpenAI API. It supports thousands of Gemini model requests per day and offers free use of the built-in Claude model in Kiro. Easily connect to any client via the API, making AI development more efficient!
...
- **简介**: The first "code-first" agent framework for seamlessly planning and executing data analytics tasks. 
...
- **简介**: Multi agent system for AI-driven software development. Combine LLM with DevOps tools to convert natural language requirements into working software. Supports any development language and extends the existing code.
...
- **简介**: tap-producing test harness for node and browsers
...
- **简介**: Democratizing Reinforcement Learning for LLMs
...
- **简介**: 多模型协作开发系统 - Claude 编排 + Codex 后端 + Gemini 前端，28 个命令覆盖开发全流程，一键安装零配置
...
- **简介**: Nexent is a zero-code platform for auto-generating agents — no orchestration, no complex drag-and-drop required. Nexent also offers powerful capabilities for agent running control, data processing and MCP tools.
...
- **简介**: 将 GeminiCLI 和 Antigravity 转换为 OpenAI 、GEMINI 和 Claude API 接口
...
- **简介**: GLM-4.5: Agentic, Reasoning, and Coding (ARC) Foundation Models
...
- **简介**: An AI agent that writes (actually useful) code for you
...
- **简介**: Design engineering for Claude Code. Craft, memory, and enforcement for consistent UI.
...
- **简介**: 734+ structured cybersecurity skills for AI agents · MITRE ATT&CK mapped · agentskills.io open standard · Works with Claude Code, GitHub Copilot, OpenAI Codex CLI, Cursor, Gemini CLI & 20+ platforms · Penetration testing, DFIR, threat intel, cloud security & more · Apache 2.0
...
- **简介**: Development environments for coding agents. Enable multiple agents to work safely and independently with your preferred stack.
...
- **简介**: Minimal CLI coding agent by Mistral
...
- **简介**: Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.
...
- **简介**: Byterover Cipher is an opensource memory layer specifically designed for coding agents. Compatible with Cursor, Codex, Claude Code, Windsurf, Cline, Claude Desktop, Gemini CLI, AWS's Kiro, VS Code, Roo Code, Trae, Amp Code and Warp through MCP. Built by https://byterover.dev/
...
- **简介**: Annotate and review coding agent plans and code diffs visually, share with your team, send feedback to agents with one click.
...
- **简介**: A framework for the evaluation of autoregressive code generation language models.
...
- **简介**: Python wrapper for AutoHotkey with full type support. Harness the automation power of AutoHotkey with the beauty of Python.
...
- **简介**: C4 is an open-source creative coding framework that harnesses the power of native iOS programming with a simplified API that gets you working with media right away. Build artworks, design interfaces and explore new possibilities working with media and interaction.
...
- **简介**: Test harness for ui tests of compiler diagnostics

### pgosar/ChatGDB

- **星数**: 940 ⭐ ⭐待AI分析
- **创建时间**: 2023-03-30
- **URL**: https://github.com/pgosar/ChatGDB
- **简介**: Harness the power of ChatGPT inside the GDB or LLDB debugger!
...
- **简介**: Cmd.exe Command Obfuscation Generator & Detection Test Harness
...
- **简介**: The ultimate setup harness for OpenClaw. Deploy in minutes. Stay running for months. No CLI required.
...
- **简介**: "Trust no one, bench everything." - sbt plugin for JMH (Java Microbenchmark Harness)
...
- **简介**: A self-hosted platform to use HandBrake on your headless devices via a bespoke web interface. Harness the processing power of multiple devices to work on a single queue.
...
- **简介**: A modular, open and non-proprietary toolkit for core robotic functionalities by harnessing deep learning
...
- **简介**: a recursive self-improving harness designed to help your agents (and future iterations of those agents) succeed on any task
...
- **简介**: Experimental one-shot benchmarking/profiling harness for Rust
...
- **简介**: Harness the power of Rust. Those fast productivity tools based on Rust.
...
- **简介**: A coding agent and general agent harness for building and orchestrating agentic applications.
...
- **星数**: 541 ⭐ ⭐待AI分析
- **创建时间**: 2013-10-27
- **URL**: https://github.com/larsonjj/generator-yeogurt
- **简介**: A generator for creating static sites. Helps you harness the power of your favorite tools: Pug or Nunjucks, Gulp, ES6/2015, and much more!
...
- **简介**: Collection of Makefiles to facilitate building Golang projects, Dockerfiles, Helm charts, and more
...
- **简介**: Freedom Fighting Mode: open source hacking harness
...
- **星数**: 326 ⭐ ⭐待AI分析
- **创建时间**: 2026-01-16
- **URL**: https://github.com/alexziskind1/llama-throughput-lab
- **简介**: Interactive launcher and benchmarking harness for llama.cpp server throughput, with tests, sweeps, and round‑robin load tools.
...
- **简介**: Evolvable, distributed agent harness for data science.

### aaemnnosttv/wp-cli-valet-command

- **星数**: 314 ⭐ ⭐待AI分析
- **创建时间**: 2016-05-13
- **URL**: https://github.com/aaemnnosttv/wp-cli-valet-command
- **简介**: Harness the power of Laravel Valet for creating fully functional WordPress installs in seconds.
...
- **简介**: This library would form a permanent home for reusable components for deep probabilistic programming. The library would form and harness a community of users and contributors by focusing initially on complete infra and documentation for how to use and create components.

### bytedance-deerflow/deer-flow-installer

- **星数**: 310 ⭐ ⭐待AI分析
- **创建时间**: 2026-03-20
- **URL**: https://github.com/bytedance-deerflow/deer-flow-installer
- **简介**: 🦌 DeerFlow 2.0 installer - open-source SuperAgent harness that researches, codes, and creates. With the help of sandboxes, memories, tools, skills and subagents, it handles different levels of tasks that could take minutes to hours.

### parikhakshat/autoharness

- **星数**: 288 ⭐ ⭐待AI分析
- **创建时间**: 2021-05-16
- **URL**: https://github.com/parikhakshat/autoharness
- **简介**: A tool that automatically creates fuzzing harnesses based on a library
...
- **简介**: Public Repo for Atomic Test Harness

### FreedomIntelligence/ALLaVA

- **星数**: 281 ⭐ ⭐待AI分析
- **创建时间**: 2024-02-14
- **URL**: https://github.com/FreedomIntelligence/ALLaVA
- **简介**: Harnessing 1.4M GPT4V-synthesized Data for A Lite Vision-Language Model
...
- **星数**: 274 ⭐ ⭐待AI分析
- **创建时间**: 2024-01-30
- **URL**: https://github.com/ZubinGou/math-evaluation-harness
- **简介**: A simple toolkit for benchmarking LLMs on mathematical reasoning tasks. 🧮✨

### digiteinfotech/kairon

- **星数**: 272 ⭐ ⭐待AI分析
- **创建时间**: 2020-04-16
- **URL**: https://github.com/digiteinfotech/kairon
- **简介**: Agentic AI platform that harnesses Visual LLM Chaining to build proactive digital assistants

### BestJunYu/Awesome-Physics-aware-Generation

- **星数**: 272 ⭐ ⭐待AI分析
- **创建时间**: 2024-12-23
- **URL**: https://github.com/BestJunYu/Awesome-Physics-aware-Generation
- **简介**: Physical laws underpin all existence, and harnessing them for generative modeling opens boundless possibilities for advancing science and shaping the future!

### philcockfield/ui-harness

- **星数**: 269 ⭐ ⭐待AI分析
- **创建时间**: 2015-06-29
- **URL**: https://github.com/philcockfield/ui-harness
- **简介**: Create, isolate and test modular UI components in React.
...
- **简介**: The production-ready agent harness framework for Python
...
- **简介**: Official Implementation of ICLR 2024 paper "Harnessing Explanations: LLM-to-LM Interpreter for Enhanced Text-Attributed Graph Representation Learning"
...
- **简介**: Contextual Harnessing for Efficient SQL Synthesis
...
- **简介**: Bundled multi-agent orchestration harness for OpenCode. One install, complete control.
...
- **星数**: 249 ⭐ ⭐待AI分析
- **创建时间**: 2011-10-07
- **URL**: https://github.com/velvia/ScalaStorm
- **简介**: Harness the power and elegance of Scala with nathanmarz's Storm real-time system
...
- **星数**: 241 ⭐ ⭐待AI分析
- **创建时间**: 2023-10-24
- **URL**: https://github.com/BlazorStatic/BlazorStatic
- **简介**: Harness the power of Blazor to craft static websites.
...
- **简介**: High-precision, one-shot and consistent benchmarking framework/harness for Rust. All Valgrind tools at your fingertips.

### WorldQL/worldql

- **星数**: 234 ⭐ ⭐待AI分析
- **创建时间**: 2021-12-31
- **URL**: https://github.com/WorldQL/worldql
- **简介**: Harness for using Dreamlab games in RL environments
...
- **简介**: Jig is an application harness providing a beautifully interactive development experience for Clojure projects.
...
- **简介**: The Runtime Security Layer for OpenClaw, the essential safety harness for PII & sensitive credentials protection.
...
- **简介**: Implementation of DragDiffusion: Harnessing Diffusion Models for Interactive Point-based Image Editing
...
- **简介**: Agent harness framework for building, running, and verifying LLM workflows
...
- **简介**: use claude code's agent teams orchestraction with any harness
...
- **简介**: Official implementation of the paper "FilterNet: Harnessing Frequency Filters for Time Series Forecasting"
...
- **简介**: A cross-platform DSP library written in C++ 11/14. This library harnesses the power of C++ templates to implement a complete set of DSP algorithms. 
...
- **简介**: Harness and benchmarks for evaluating Django's performance over time
...
- **简介**:  A curated list of Awesome-LLM-Ensemble papers for the survey "Harnessing Multiple Large Language Models: A Survey on LLM Ensemble"

### realmacsoftware/RMErrorRecoveryAttempter

- **星数**: 210 ⭐ ⭐待AI分析
- **创建时间**: 2012-10-17
- **URL**: https://github.com/realmacsoftware/RMErrorRecoveryAttempter
- **简介**: RMErrorRecoveryAttempter is a class that conforms to the `NSErrorRecoveryAttempting` informal protocol and harnesses the power of blocks allowing you to provide recovery options for an error.
...
- **简介**: :package: :yum: Laravel 5 Package that harnesses the power of PHP 7 unicode features to provide emojis in your laravel app
...
- **简介**: Local-first persistent agentic memory powered by Recursive Memory Harness (RMH). Open source must win.

### harness/harness-cd-community

- **星数**: 207 ⭐ ⭐待AI分析
- **创建时间**: 2021-11-09
- **URL**: https://github.com/harness/harness-cd-community
- **简介**: Retired: Harness CD Community Edition is a modern self-service continuous delivery solution that allows developers to deploy, verify and automatically rollback Kubernetes and other cloud-native applications on any public or private cloud infrastructure of their choice.
