...
### instructkr/clawd-code

- **星数**: 30990 ⭐ ⭐待AI分析
- **创建时间**: 2026-03-31
- **URL**: https://github.com/instructkr/clawd-code
- **简介**: An independent Python feature port of alike to Claude Code, entirely rewritting from scratch using oh-my-codex. Educational Purpose only.
