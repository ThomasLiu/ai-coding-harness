...
- **简介**: Stop juggling AI accounts. Quotio is a beautiful native macOS menu bar app that unifies your Claude, Gemini, OpenAI, Qwen, and Antigravity subscriptions – with real-time quota tracking and smart auto-failover for AI coding tools like Claude Code, OpenCode, and Droid.
...
- **星数**: 223 ⭐ ⭐待AI分析
- **创建时间**: 2025-08-11
- **URL**: https://github.com/bgdnvk/clanker
- **简介**: autonomous systems engineering cli agent for any cloud environment: AWS, GCP, Cloudflare, etc
