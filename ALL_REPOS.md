...
> 所有收录的 AI Coding Harness 仓库 | 共 321 个 | 已 AI 分析: 12 个
...
- **简介**: AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, OpenClaw, Factory Droid, Trae). Turn any folder of code, docs, papers, or images into a queryable knowledge graph
